          ...
          <div className="flex flex-col items-center">
            ...
            >
              <div className="flex flex-col items-center px-8 py-16">
                <div
                  className={`mb-4 rounded-full p-3 ${isDragging ? 'bg-blue-100' : 'bg-neutral-100'}`}
                >
                  <svg
                    className={`h-6 w-6 ${isDragging ? 'text-blue-600' : 'text-neutral-400'}`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1.5}
                ...
                <p className="mb-6 text-xs text-neutral-500">PDF, PNG, JPG, or CSV files</p>
                <button
                  type="button"
                ...
                <div className="flex gap-8">
                  <div>
                    ...
                    <p className="text-2xl font-semibold">
                      {formatCurrency(normalized.totals.monthly, normalized.currency)}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-emerald-100">Annual spend</p>
                    <p className="text-2xl font-semibold">
                      {formatCurrency(normalized.totals.yearly, normalized.currency)}
                    </p>
                  </div>
                  <div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-neutral-500">
            ...
            {subscription.notes && (
              <span className="ml-2 text-neutral-400">· {subscription.notes}</span>
            )}
          </p>
        </div>
      </div>
      <div className="flex items-center gap-6">
        <div className="text-right">
          <p className="font-semibold text-neutral-900">
            {formatCurrency(subscription.annualCost, currency)}
          </p>
